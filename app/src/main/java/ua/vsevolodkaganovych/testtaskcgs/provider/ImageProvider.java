...
public class ImageProvider extends ContentProvider {
    ...
    private static final String TYPE_CURSOR_ITEM = "vnd.android.cursor.item_search/";
    private static final String TYPE_CURSOR_DIR = "vnd.android.cursor.dir/";

    public static final String AUTHORITY = "ua.vsevolodkaganovych.testtaskcgs.provider";
    public static final String CONTENT_URI_BASE = "content://" + AUTHORITY;

    public static final String QUERY_NOTIFY = "QUERY_NOTIFY";
    public static final String QUERY_GROUP_BY = "QUERY_GROUP_BY";

    private static final int URI_TYPE_IMAGE = 0;
    private static final int URI_TYPE_IMAGE_ID = 1;
    ...
    static {
        URI_MATCHER.addURI(AUTHORITY, ImageColumns.TABLE_NAME, URI_TYPE_IMAGE);
        URI_MATCHER.addURI(AUTHORITY, ImageColumns.TABLE_NAME + "/#", URI_TYPE_IMAGE_ID);
    }

    protected ImageDBHelper mImageDBHelper;
    ...
    public boolean onCreate() {
        ...
        mImageDBHelper = ImageDBHelper.getInstance(getContext());
        return true;
    }
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            case URI_TYPE_IMAGE:
                return TYPE_CURSOR_DIR + ImageColumns.TABLE_NAME;
            case URI_TYPE_IMAGE_ID:
                return TYPE_CURSOR_ITEM + ImageColumns.TABLE_NAME;
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        long rowId = mImageDBHelper.getWritableDatabase().insertOrThrow(table, null, values);
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        int res = mImageDBHelper.getWritableDatabase().update(queryParams.table, values, queryParams.selection, selectionArgs);
        String notify;
        if (res != 0 && ((notify = uri.getQueryParameter(QUERY_NOTIFY)) == null || "true".equals(notify))) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        QueryParams queryParams = getQueryParams(uri, selection, null);
        int res = mImageDBHelper.getWritableDatabase().delete(queryParams.table, queryParams.selection, selectionArgs);
        String notify;
        if (res != 0 && ((notify = uri.getQueryParameter(QUERY_NOTIFY)) == null || "true".equals(notify))) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        Cursor res = mImageDBHelper.getReadableDatabase().query(queryParams.tablesWithJoins, projection, queryParams.selection, selectionArgs, groupBy,
    ...
    private QueryParams getQueryParams(Uri uri, String selection, String[] projection) {
        ...
        switch (matchedId) {
            case URI_TYPE_IMAGE:
            case URI_TYPE_IMAGE_ID:
                res.table = ImageColumns.TABLE_NAME;
                res.tablesWithJoins = ImageColumns.TABLE_NAME;
                res.orderBy = ImageColumns.DEFAULT_ORDER;
                break;
